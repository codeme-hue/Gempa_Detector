...
import id.kardihaekal.gempa_detector.adapter.GempaAdapter
import id.kardihaekal.gempa_detector.api.ApiInstance
        ...
        when (v.id) {
            R.id.website -> {
                val intent = Intent(Intent.ACTION_VIEW).apply {
                    data = Uri.parse("https://github.com/kardihaekal")
                }
